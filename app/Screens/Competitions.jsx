  ...
  const renderUser = () => {
    ...
    return (
      <View style={[styles.itemContainer, styles.highlightedItem, { width: screenWidth * 0.97 }]}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.name}>Your place {personalMdrt.mdrt_rank}</Text>
          <Text style={styles.achievedTarget}>Sales amount: {personalMdrt.fyp?.toLocaleString('en-US', { maximumFractionDigits: 2 })}</Text>
        </View>
      </View>
    );
  };
